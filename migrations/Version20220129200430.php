 ...
 */
final class Version20220129200430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, category_id, title, content, auteur, date, tags, etat FROM article');
        ...
        $this->addSql('INSERT INTO article (id, category_id, title, content, auteur, date, tags, etat) SELECT id, category_id, title, content, auteur, date, tags, etat FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E6612469DE2 ON article (category_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__auteurs AS SELECT id, nnom, prenom, description, liste_creations, pseudo FROM auteurs');
        ...
        $this->addSql('INSERT INTO auteurs (id, nnom, prenom, description, liste_creations, pseudo) SELECT id, nnom, prenom, description, liste_creations, pseudo FROM __temp__auteurs');
