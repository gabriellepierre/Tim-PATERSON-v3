 ...
 */
final class Version20220130185058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , etat BOOLEAN DEFAULT NULL, resume CLOB DEFAULT NULL, CONSTRAINT FK_23A0E6612469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
